 ...
 */
final class Version20241011103239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trick (id INT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, image TEXT DEFAULT NULL, video TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D8F0A91E12469DE2 ON trick (category_id)');
        $this->addSql('COMMENT ON COLUMN trick.image IS \'(DC2Type:array)\'');
        $this->addSql('COMMENT ON COLUMN trick.video IS \'(DC2Type:array)\'');
